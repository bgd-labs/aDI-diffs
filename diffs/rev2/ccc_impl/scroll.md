```diff
diff --git a/flattened/rev2/ccc_impl/current/scroll/CrossChainController.sol b/flattened/rev2/ccc_impl/new/scroll/CrossChainController.sol
index f58d039..1fb7f55 100644
--- a/flattened/rev2/ccc_impl/current/scroll/CrossChainController.sol
+++ b/flattened/rev2/ccc_impl/new/scroll/CrossChainController.sol
@@ -1,7 +1,7 @@
 // SPDX-License-Identifier: BUSL-1.1
 pragma solidity >=0.7.0 ^0.8.0 ^0.8.1 ^0.8.2 ^0.8.8;
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/openzeppelin-contracts/contracts/utils/structs/EnumerableSet.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/openzeppelin-contracts/contracts/utils/structs/EnumerableSet.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/access-control/interfaces/IWithGuardian.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/access-control/interfaces/IWithGuardian.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/oz-common/Address.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/Address.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/oz-common/Context.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/Context.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20Permit.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20Permit.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/utils/interfaces/IRescuable.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/utils/interfaces/IRescuable.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/adapters/IBaseAdapter.sol
-
-/**
- * @title IBaseAdapter
- * @author BGD Labs
...
-}
-
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/interfaces/IBaseReceiverPortal.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/interfaces/IBaseReceiverPortal.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/libs/EncodingUtils.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/libs/EncodingUtils.sol
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/libs/Errors.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/libs/Errors.sol
 
 /**
  * @title Errors library
@@ -1310,9 +1238,26 @@ library Errors {
...
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/oz-common/Ownable.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/revisions/update_to_rev_2/IReinitialize.sol
+
+/**
+ * @title IReinitialize
+ * @author BGD Labs
...
+}
+
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/Ownable.sol
 
 // OpenZeppelin Contracts (last updated v4.7.0) (access/Ownable.sol)
 // From commit https://github.com/OpenZeppelin/openzeppelin-contracts/commit/8b778fa20d6d76340c5fac1ed66c80273f05b95a
@@ -1400,7 +1345,7 @@ abstract contract Ownable is Context {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/transparent-proxy/Initializable.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/transparent-proxy/Initializable.sol
 
 /**
  * @dev OpenZeppelin Contracts (last updated v4.7.0) (proxy/utils/Initializable.sol)
@@ -1554,7 +1499,7 @@ abstract contract Initializable {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/interfaces/ICrossChainForwarder.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/interfaces/ICrossChainForwarder.sol
 
 /**
  * @title ICrossChainForwarder
@@ -1782,7 +1727,7 @@ interface ICrossChainForwarder {
     function isSenderApproved(address sender) external view returns (bool);
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/interfaces/ICrossChainReceiver.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/interfaces/ICrossChainReceiver.sol
 
 /**
  * @title ICrossChainReceiver
@@ -2061,7 +2006,7 @@ interface ICrossChainReceiver {
     ) external;
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/access-control/OwnableWithGuardian.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/access-control/OwnableWithGuardian.sol
 
 abstract contract OwnableWithGuardian is Ownable, IWithGuardian {
     address private _guardian;
@@ -2113,7 +2058,7 @@ abstract contract OwnableWithGuardian is Ownable, IWithGuardian {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/oz-common/SafeERC20.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/SafeERC20.sol
...
@@ -2290,7 +2235,7 @@ library SafeERC20 {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/lib/solidity-utils/src/contracts/utils/Rescuable.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/lib/solidity-utils/src/contracts/utils/Rescuable.sol
 
 /**
  * @title Rescuable
@@ -2332,7 +2277,7 @@ abstract contract Rescuable is IRescuable {
     function whoCanRescue() public view virtual returns (address);
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/interfaces/IBaseCrossChainController.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/interfaces/IBaseCrossChainController.sol
 
 /**
  * @title IBaseCrossChainController
@@ -2347,7 +2292,98 @@ interface IBaseCrossChainController is
 
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/interfaces/ICrossChainController.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/adapters/IBaseAdapter.sol
+
+/**
+ * @title IBaseAdapter
+ * @author BGD Labs
...
+}
+
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/interfaces/ICrossChainController.sol
 
 /**
  * @title ICrossChainController
@@ -2375,7 +2411,376 @@ interface ICrossChainController is IBaseCrossChainController {
     ) external;
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/CrossChainForwarder.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/CrossChainReceiver.sol
+
+/**
...
+}
+
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/CrossChainForwarder.sol
 
 /**
  * @title CrossChainForwarder
@@ -2875,374 +3280,7 @@ contract CrossChainForwarder is OwnableWithGuardian, ICrossChainForwarder {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/CrossChainReceiver.sol
-
-/**
- * @title CrossChainReceiver
- * @author BGD Labs
...
-}
-
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/BaseCrossChainController.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/BaseCrossChainController.sol
 
 /**
  * @title BaseCrossChainController
@@ -3310,7 +3348,7 @@ contract BaseCrossChainController is
     receive() external payable {}
 }
 
-// etherscan/rev2/current/ccc_impl/scroll/CrossChainController/src/contracts/CrossChainController.sol
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/CrossChainController.sol
 
 /**
  * @title CrossChainController
@@ -3341,3 +3379,19 @@ contract CrossChainController is
         );
     }
 }
+
+// etherscan/rev2/new/ccc_impl/scroll/CrossChainControllerUpgradeRev2/src/contracts/revisions/update_to_rev_2/CrossChainController.sol
+
+/**
