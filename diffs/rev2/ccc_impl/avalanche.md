```diff
diff --git a/flattened/rev2/ccc_impl/current/avalanche/CrossChainControllerWithEmergencyMode.sol b/flattened/rev2/ccc_impl/new/avalanche/CrossChainControllerWithEmergencyMode.sol
index 4811fae..e8d63dd 100644
--- a/flattened/rev2/ccc_impl/current/avalanche/CrossChainControllerWithEmergencyMode.sol
+++ b/flattened/rev2/ccc_impl/new/avalanche/CrossChainControllerWithEmergencyMode.sol
@@ -1,9 +1,9 @@
 // SPDX-License-Identifier: BUSL-1.1
 pragma solidity >=0.7.0 ^0.8.0 ^0.8.1 ^0.8.2 ^0.8.8;
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/openzeppelin-contracts/contracts/utils/structs/EnumerableSet.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/openzeppelin-contracts/contracts/utils/structs/EnumerableSet.sol
...
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/access-control/interfaces/IWithGuardian.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/access-control/interfaces/IWithGuardian.sol
...
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/oz-common/Address.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/Address.sol
...
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/oz-common/Context.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/Context.sol
...
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20.sol
...
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20Permit.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20Permit.sol
...
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/utils/interfaces/IRescuable.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/utils/interfaces/IRescuable.sol
...
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/adapters/IBaseAdapter.sol
-
-/**
- * @title IBaseAdapter
- * @author BGD Labs
...
-}
-
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/emergency/interfaces/ICLEmergencyOracle.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/emergency/interfaces/ICLEmergencyOracle.sol
 
 interface ICLEmergencyOracle {
     /**
@@ -1099,7 +1027,7 @@ interface ICLEmergencyOracle {
         );
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/emergency/interfaces/IEmergencyConsumer.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/emergency/interfaces/IEmergencyConsumer.sol
 
 interface IEmergencyConsumer {
     /**
@@ -1135,7 +1063,7 @@ interface IEmergencyConsumer {
     function updateCLEmergencyOracle(address chainlinkEmergencyOracle) external;
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/interfaces/IBaseReceiverPortal.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/interfaces/IBaseReceiverPortal.sol
 
 /**
  * @title IBaseReceiverPortal
@@ -1157,7 +1085,7 @@ interface IBaseReceiverPortal {
     ) external;
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/libs/EncodingUtils.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/libs/EncodingUtils.sol
 
 using EnvelopeUtils for Envelope global;
 using TransactionUtils for Transaction global;
@@ -1336,7 +1264,7 @@ library TransactionUtils {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/libs/Errors.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/libs/Errors.sol
 
 /**
  * @title Errors library
@@ -1378,11 +1306,31 @@ library Errors {
...
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/oz-common/Ownable.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/revisions/update_to_rev_2/IReinitialize.sol
+
+/**
+ * @title IReinitialize
+ * @author BGD Labs
...
+}
+
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/Ownable.sol
 
 // OpenZeppelin Contracts (last updated v4.7.0) (access/Ownable.sol)
 // From commit https://github.com/OpenZeppelin/openzeppelin-contracts/commit/8b778fa20d6d76340c5fac1ed66c80273f05b95a
@@ -1470,7 +1418,7 @@ abstract contract Ownable is Context {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/transparent-proxy/Initializable.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/transparent-proxy/Initializable.sol
 
 /**
  * @dev OpenZeppelin Contracts (last updated v4.7.0) (proxy/utils/Initializable.sol)
@@ -1624,7 +1572,7 @@ abstract contract Initializable {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/interfaces/ICrossChainForwarder.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/interfaces/ICrossChainForwarder.sol
 
 /**
  * @title ICrossChainForwarder
@@ -1852,7 +1800,7 @@ interface ICrossChainForwarder {
     function isSenderApproved(address sender) external view returns (bool);
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/interfaces/ICrossChainReceiver.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/interfaces/ICrossChainReceiver.sol
 
 /**
  * @title ICrossChainReceiver
@@ -2131,7 +2079,7 @@ interface ICrossChainReceiver {
     ) external;
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/access-control/OwnableWithGuardian.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/access-control/OwnableWithGuardian.sol
 
 abstract contract OwnableWithGuardian is Ownable, IWithGuardian {
     address private _guardian;
@@ -2183,7 +2131,7 @@ abstract contract OwnableWithGuardian is Ownable, IWithGuardian {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/oz-common/SafeERC20.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/oz-common/SafeERC20.sol
...
@@ -2360,7 +2308,7 @@ library SafeERC20 {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/emergency/EmergencyConsumer.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/emergency/EmergencyConsumer.sol
 
 abstract contract EmergencyConsumer is IEmergencyConsumer {
     address internal _chainlinkEmergencyOracle;
@@ -2428,7 +2376,7 @@ abstract contract EmergencyConsumer is IEmergencyConsumer {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/lib/solidity-utils/src/contracts/utils/Rescuable.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/lib/solidity-utils/src/contracts/utils/Rescuable.sol
 
 /**
  * @title Rescuable
@@ -2470,7 +2418,7 @@ abstract contract Rescuable is IRescuable {
     function whoCanRescue() public view virtual returns (address);
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/interfaces/IBaseCrossChainController.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/interfaces/IBaseCrossChainController.sol
 
 /**
  * @title IBaseCrossChainController
@@ -2485,7 +2433,98 @@ interface IBaseCrossChainController is
 
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/interfaces/ICrossChainControllerWithEmergencyMode.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/adapters/IBaseAdapter.sol
+
+/**
+ * @title IBaseAdapter
+ * @author BGD Labs
...
+}
+
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/interfaces/ICrossChainControllerWithEmergencyMode.sol
 
 /**
  * @title ICrossChainControllerWithEmergencyMode
@@ -2543,7 +2582,376 @@ interface ICrossChainControllerWithEmergencyMode is
     ) external;
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/CrossChainForwarder.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/CrossChainReceiver.sol
+
+/**
...
+}
+
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/CrossChainForwarder.sol
 
 /**
  * @title CrossChainForwarder
@@ -3043,374 +3451,7 @@ contract CrossChainForwarder is OwnableWithGuardian, ICrossChainForwarder {
     }
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/CrossChainReceiver.sol
-
-/**
- * @title CrossChainReceiver
- * @author BGD Labs
...
-}
-
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/BaseCrossChainController.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/BaseCrossChainController.sol
 
 /**
  * @title BaseCrossChainController
@@ -3478,7 +3519,7 @@ contract BaseCrossChainController is
     receive() external payable {}
 }
 
-// etherscan/rev2/current/ccc_impl/avalanche/CrossChainControllerWithEmergencyMode/src/contracts/CrossChainControllerWithEmergencyMode.sol
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/CrossChainControllerWithEmergencyMode.sol
 
 /**
  * @title CrossChainControllerWithEmergencyMode
@@ -3550,3 +3591,23 @@ contract CrossChainControllerWithEmergencyMode is
     /// @notice method that ensures access control validation
     function _validateEmergencyAdmin() internal override onlyOwner {}
 }
+
+// etherscan/rev2/new/ccc_impl/avalanche/CrossChainControllerWithEmergencyModeUpgradeRev2/src/contracts/revisions/update_to_rev_2/CrossChainControllerWithEmergencyMode.sol
+
+/**
